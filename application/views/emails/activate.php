								  		...
								  		<tbody>
								  			<tr>
									  			<td>
										  			...
										  			<h4 style="color:#333;text-transform:none;text-align:center;font-weight:bold;font-size:18px;margin:0;border:15px white solid;background:white">Activez votre compte!</h4>
										  			<hr width="480" height="1" style="border:0;margin:5px auto 30px;background-color:#e8e8e8;min-height:1px">
										  			<p style="font-size:16px;line-height:27px;margin-top:0;margin-bottom:22px;margin-left:20px;margin-right:20px;color:#999999">Merci de <strong>confirmer votre email</strong> et <strong>choisir un mot de passe</strong> afin d'activer votre compte.<br/>Vous avez besoin d'activer votre compte pour réserver votre premier <i>live streaming</i>.</p>
										  			<p style="font-size:16px;line-height:27px;margin-top:0;margin-bottom:22px;margin-left:20px;margin-right:20px;color:#999999">
										  				<a style="color:white;display:block;text-align:center;font-weight:bold;background:#36a9ae;border:1px solid #4a8589;border-radius:4px;padding:12px 15px;text-decoration:none" href="<?php echo base_url($channel.'/activate/'.$token);?>" target="_blank">Confirmer mon email</a>
										  			</p>
